...
HEADERS_ENG: dict = {
    ...
    ("Грузополучатель наим по ПУЖТ", "Грузополучатель по ПУЖТ", "Грузополучатель", "Грузополучатель наим"): "consignee_by_puzt",
    ...
    ("Категория отпр", "Категория отправки", "Тип отправки"): "dispatch_category",
    ...
    ("Условный тип вагона", "Условнй тип вагона"): "conditional_wagon_type",
